        ...
        <div className="p-6 rounded-[16px] bg-surface border border-base shadow-sm space-y-4">
          ...
          <div className="divide-y divide-base">
            {[
              ...
              { good: instructionsCount > 0, title: 'Family instructions', sub: instructionsCount > 0 ? `${instructionsCount} written in plain language` : 'No instructions written yet — guardians will be guessing', badge: instructionsCount > 0 ? `${instructionsCount} written` : 'None', action: instructionsCount > 0 ? null : 'Write one', onAction: () => navigate('/instructions') },
