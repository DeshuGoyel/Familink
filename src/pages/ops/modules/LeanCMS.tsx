...
const DEFAULT_STRUCTURES: Record<string, unknown> = {
...
export default function LeanCMS() {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const errorMsg = (err as { message?: string }).message || 'Failed to publish changes';
  ...
  const updateField = (field: string, value: unknown) => {
    setFormData(prev => ({ ...(prev as Record<string, unknown>), [field]: value }));
  };
  ...
  const renderEditor = () => {
    switch (selectedSlug) {
          ...
          <div className="space-y-6 animate-in fade-in slide-in-from-bottom-2 duration-300">
            <div className="space-y-2">
              ...
              <input 
                ...
                value={(formDataTyped.title as string) || ''}
            ...
            <div className="space-y-2">
              ...
              <textarea 
                ...
                value={(formDataTyped.subtitle as string) || ''}
      ...
      case 'faqs': {
        const formDataTyped = formData as Record<string, unknown>;
        const faqItems = (formDataTyped.items as Record<string, string>[]) || [];
        return (
          <div className="space-y-6 animate-in fade-in slide-in-from-bottom-2 duration-300">
            ...
            <div className="space-y-4">
              {faqItems.map((item: Record<string, string>, idx: number) => (
                <div key={idx} className="bg-slate-950 border border-slate-800 p-4 rounded-2xl relative group">
                  ...
                  <button 
                    onClick={() => updateField('items', faqItems.filter((_, i) => i !== idx))}
      ...
      case 'features': {
        const formDataTyped = formData as Record<string, unknown>;
        const featItems = (formDataTyped.items as Record<string, string>[]) || [];
        return (
          <div className="space-y-6 animate-in fade-in slide-in-from-bottom-2 duration-300">
            <div className="flex items-center justify-between mb-2">
            ...
            <div className="space-y-4">
              {featItems.map((item: Record<string, string>, idx: number) => (
                <div key={idx} className="bg-slate-950 border border-slate-800 p-5 rounded-2xl flex gap-4">
                  ...
                  <button 
                    onClick={() => updateField('items', featItems.filter((_, i) => i !== idx))}
      ...
      case 'team': {
        const formDataTyped = formData as Record<string, unknown>;
        const teamItems = (formDataTyped.items as Record<string, string>[]) || [];
        return (
          <div className="space-y-6 animate-in fade-in slide-in-from-bottom-2 duration-300">
            <div className="flex items-center justify-between mb-2">
            ...
            <div className="grid grid-cols-1 gap-6">
              {teamItems.map((member: Record<string, string>, idx: number) => (
                <Card key={idx} className="bg-slate-950 border-slate-800 p-6 flex flex-col md:flex-row gap-6 items-start">
                  ...
                  <div className="flex-1 grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="md:col-span-2 space-y-1">
                      ...
                      <textarea 
                        ...
                        onChange={(e) => {
                          const newItems = [...teamItems];
                          newItems[idx] = { ...newItems[idx], bio: e.target.value };
                          updateField('items', newItems);
                        }}
                      />
                    </div>
                  ...
                  <button 
                    onClick={() => updateField('items', teamItems.filter((_, i) => i !== idx))}
                    className="p-2 text-slate-700 hover:text-red-500"
                  >
